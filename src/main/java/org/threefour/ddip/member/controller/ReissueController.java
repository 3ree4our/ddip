...
public class ReissueController {
  ...
  * */
  @PostMapping("/reissue")
  public ResponseEntity<?> reissue(HttpServletRequest request, HttpServletResponse response, Authentication authResult) {
    String refresh = null;
    ...
    String newAccess = jwtUtil.createJwt(id, role, "access", username, nickname, /*role,*/ 600000L);
    String newRefresh = jwtUtil.createJwt(id, role, "refresh", username, nickname, 43200000L);
