            ...
            steps {
                script {
                    withCredentials([
                        ...
                        scp -i "$EC2_DEPLOY_KEY_FOR_DDIP" "$JAR_PATH" ubuntu@"$EC2_IP_FOR_DDIP":"$EC2_DEPLOY_PATH"
